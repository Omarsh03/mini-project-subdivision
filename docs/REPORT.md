...
The optional 3D Loop-subdivision bonus was not attempted; the time went into
the 2D core and the experiments below.
...
Natural extensions (kept out of scope): open-polyline editing in the UI,
asymmetric Chaikin cuts, and the 3D Loop-subdivision bonus on a cube.
